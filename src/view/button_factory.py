...
class ButtonFactory:
    def __init__(self, left_click_callback, right_click_callback):
        ...
        self.default_image = tk.PhotoImage(file="src/resources/button_default(small).gif")
        self.flagged_image = tk.PhotoImage(file="src/resources/button_flagged(small).gif")
        self.question_mark_image = tk.PhotoImage(file="src/resources/button_question_mark(small).gif")
